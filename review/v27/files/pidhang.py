...
if __name__=="__main__":
    ...
    o28,l28=trials(os.path.join(cand,"v28.sh"),"v28")
    print()
    ...
    print("v28: orphaned in %d landed runs -> %s"%(o28,"LEAKS" if o28>0 else "CLEAN (H1 fixed)"))
    ok = (o26>0 and o27==0 and o28==0 and l28>0)
    print("\n%s"%("*** DISCRIMINATED: v26 leaks, v27+v28 clean across >=%d landed trials ***"%min(l27,l28) if ok else "INCONCLUSIVE (need more landed trials or unexpected)"))
