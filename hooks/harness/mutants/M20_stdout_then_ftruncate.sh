...
# M20 (2026-09-06): write to stdout, then ftruncate fd 1 to zero before exiting.
# A grader that reads stdout back from a regular capture file by size sees 0 bytes.
printf 'LEAK5' 
/usr/bin/python3 -c 'import os; os.ftruncate(1,0)' 2>/dev/null || builtin true
