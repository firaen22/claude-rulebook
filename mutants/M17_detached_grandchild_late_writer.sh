...
# MUTANT M17 (grok 2026-09-02 F2/F3): a double-forked, setsid grandchild escapes
# the hook's pgid and job table, sleeps past SETTLE, then writes on inherited fd 1.
/usr/bin/python3 -c 'import os,sys,time
if os.fork()==0:
  os.setsid(); time.sleep(3); sys.stdout.write("LEAK"); sys.stdout.flush()'
